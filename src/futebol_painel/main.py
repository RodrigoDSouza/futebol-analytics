...
from futebol_painel.api.client import DadosFutebolClient
from futebol_painel.api.exceptions import DadosFutebolError
from futebol_painel.config.settings import ConfigurationError, Settings
from futebol_painel.services.campeonatos import (
